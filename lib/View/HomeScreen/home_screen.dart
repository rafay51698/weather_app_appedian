...
import 'package:weather_app_appedian/Controller/home_controller.dart';
                                    ...
                                    child: RichText(
                                      text: TextSpan(
                                        children: <TextSpan>[
                                          TextSpan(
                                            text:
                                                '${controller.weatherResponse?.value?.main?.temp ?? ""}',
                                            style: TextStyle(
                                          ...
                                          TextSpan(
                                            text:
                                                '${controller.weatherResponse?.value?.weather?[0].main ?? ""}',
                                            style: TextStyle(
                                              fontFamily: 'MohrRounded',
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    width: 60,
                                    child: Text(
                                      '${controller.weatherResponse?.value?.clouds ?? ""}',
                                      style: TextStyle(
                                        fontSize: 10,
                                      ),
                                      textAlign: TextAlign.center,
                                  ...
                                  Container(
                                    ...
                                    width: 60,
                                    child: Text(
                                      '${controller.weatherResponse?.value?.main?.humidity ?? "" ?? ""}%',
                                      style: TextStyle(
                                        fontSize: 10,
                                      ),
                                      textAlign: TextAlign.center,
